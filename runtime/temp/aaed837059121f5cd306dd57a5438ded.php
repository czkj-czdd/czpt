<?php /*a:2:{s:51:"/www/wwwroot/www.biand.xyz/view/index/order_cx.html";i:1732714299;s:56:"/www/wwwroot/www.biand.xyz/view/layout/index_footer.html";i:1728755148;}*/ ?>
<!DOCTYPE html>
                ...
                $.post("/order_cx_list",{
                    ...
                    if (list.length > 0) {
                        $.each(list, function (index, item) {
                            var operate = ``;
                            if(item.status == 0){
                                var status = `<div class="btn1 flexJA primary">认购中</div>`;
