<?php /*a:3:{s:55:"/www/wwwroot/103.117.122.101/view/admin/withdrawal.html";i:1736872451;s:58:"/www/wwwroot/103.117.122.101/view/layout/admin_header.html";i:1736942563;s:58:"/www/wwwroot/103.117.122.101/view/layout/admin_footer.html";i:1736919110;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
    ...
    function dels() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "<?php echo getConfig('backstage_entrance'); ?>/withdrawal_post/dels",
                    method: 'POST',
                    data: {
                        ids:ids,
                    },
