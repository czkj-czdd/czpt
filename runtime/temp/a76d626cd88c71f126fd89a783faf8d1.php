<?php /*a:3:{s:58:"/www/wwwroot/th.pay51888.vip/view/admin/rebate_record.html";i:1736872451;s:58:"/www/wwwroot/th.pay51888.vip/view/layout/admin_header.html";i:1736942563;s:58:"/www/wwwroot/th.pay51888.vip/view/layout/admin_footer.html";i:1736919110;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
    ...
    function del(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo getConfig('backstage_entrance'); ?>/rebate_record_post/del",
                    method: 'POST',
                    data: {
                        id: id,
                    },
    ...
    function dels() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "<?php echo getConfig('backstage_entrance'); ?>/rebate_record_post/dels",
                    method: 'POST',
                    data: {
                        ids:ids,
                    },
