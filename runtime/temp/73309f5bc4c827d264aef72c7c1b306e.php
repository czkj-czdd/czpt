<?php /*a:1:{s:66:"/www/wwwroot/www.czysqcrxw.site/5555/view/index/order_voucher.html";i:1732124545;}*/ ?>
<!DOCTYPE html>
	...
	<body class="uni-body pages-order-orderDetails">
        ...
        <div class="container">
            ...
            <div class="fixation">
                <div class="btn flexJA flexSb">
                    <a class="btn1 flexJA" href="/order_voucher_edit">编辑内容</a>
        ...
        <script>
            ...
            image.onload = function() {
                ...
                ctx.font = '20px Arial';ctx.fillStyle = 'white';ctx.textAlign = 'left';ctx.fillText('2024-11-21 00:00:00', 200, 530);
           
                ctx.font = '20px Arial';ctx.fillStyle = '#939393';ctx.textAlign = 'left';ctx.fillText('商品', 50, 580);
                ctx.font = '20px Arial';ctx.fillStyle = 'white';ctx.textAlign = 'left';ctx.fillText('900元手机话费充值', 200, 580);
           
                ctx.font = '20px Arial';ctx.fillStyle = '#939393';ctx.textAlign = 'left';ctx.fillText('商户全村', 50, 630);
                ctx.font = '20px Arial';ctx.fillStyle = 'white';ctx.textAlign = 'left';ctx.fillText('啊啊啊啊啊', 200, 630);
           
                ctx.font = '20px Arial';ctx.fillStyle = '#939393';ctx.textAlign = 'left';ctx.fillText('收单机构', 50, 680);
                ctx.font = '20px Arial';ctx.fillStyle = 'white';ctx.textAlign = 'left';ctx.fillText('鹅鹅鹅饿', 200, 680);
                ...
                ctx.font = '20px Arial';ctx.fillStyle = 'white';ctx.textAlign = 'left';ctx.fillText('6666666666666', 200, 830);
