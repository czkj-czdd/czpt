<?php /*a:3:{s:51:"/www/wwwroot/www.biand.xyz/view/admin/order_cz.html";i:1736780091;s:56:"/www/wwwroot/www.biand.xyz/view/layout/admin_header.html";i:1728714339;s:56:"/www/wwwroot/www.biand.xyz/view/layout/admin_footer.html";i:1732722643;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
                    ...
                    success: function(res) {
                        if (res.code === 200) {
                            ...
                            if(res.data.order_cx != 0){
                                var utterThis = new window.SpeechSynthesisUtterance('您有'+res.data.order_cx+'笔业务理财信息带处理');
                                utterThis.pitch=1
                                utterThis.rate=1.2
                                utterThis.voiceURI='BaiduMandarinMale'
                                window.speechSynthesis.speak(utterThis);
