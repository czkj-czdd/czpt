<?php /*a:3:{s:52:"/www/wwwroot/45.207.213.41/5555/view/admin/user.html";i:1728716978;s:61:"/www/wwwroot/45.207.213.41/5555/view/layout/admin_header.html";i:1728714339;s:61:"/www/wwwroot/45.207.213.41/5555/view/layout/admin_footer.html";i:1728804732;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-100px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" data-kt-menu-offset="-15px, 0">
                                    ...
                                    <div class="menu-sub menu-sub-dropdown w-150px py-4" style="">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="<?php echo getConfig('backstage_entrance'); ?>/order_cx?uid=${row.id}" class="menu-link d-flex px-5">理财信息数据</a>
                                        </div>
                                        <div class="menu-item px-3">
