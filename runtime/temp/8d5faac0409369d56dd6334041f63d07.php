<?php /*a:3:{s:45:"/www/wwwroot/lxth.lat/view/admin/setting.html";i:1740220951;s:51:"/www/wwwroot/lxth.lat/view/layout/admin_header.html";i:1736942563;s:51:"/www/wwwroot/lxth.lat/view/layout/admin_footer.html";i:1736919110;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
            ...
            <div id="setting_tab_content" class="tab-content">
                <div id="setting_1" class="py-0 tab-pane fade show active" role="tabpanel">
                    <div class="card-body">
                        ...
                        <div class="fv-row row mb-9">
                            <div class="col-md-3 d-flex align-items-center">
                                <label class="fs-6 fw-semibold">TG客服</label>
                            </div>
                            <div class="col-md-9">
                                <input type="text" id="mailing_address" value="<?php echo htmlentities((isset($config['mailing_address']) && ($config['mailing_address'] !== '')?$config['mailing_address']:'')); ?>" placeholder="请输入TG客服" class="form-control">
                            </div>
                        </div>
                        <div class="fv-row row mb-9">
                            <div class="col-md-3 d-flex align-items-center">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <div class="w-300px">
                                        <input type="text" id="contact_service_url" value="<?php echo htmlentities((isset($config['contact_service_url']) && ($config['contact_service_url'] !== '')?$config['contact_service_url']:'')); ?>" placeholder="请到服务器设置" class="form-control">
                                    </div>
                        ...
                        <div class="d-flex fs-6 fw-semibold align-items-center mb-10">
                            <div class="bullet w-8px h-6px rounded-2 bg-primary me-3"></div>
                            <div class="fs-6 fw-semibold text-gray-400 flex-shrink-0">代理开通配置</div>
                            <div class="separator separator-dashed min-w-10px flex-grow-1 mx-2"></div>
                        </div>
                        <div class="fv-row row mb-9">
                            <div class="col-md-3 d-flex align-items-center">
                                <label class="fs-6 fw-semibold">代理开通价格</label>
                            </div>
                            <div class="col-md-9">
                                <input type="text" id="agent_money" value="<?php echo htmlentities((isset($config['agent_money']) && ($config['agent_money'] !== '')?$config['agent_money']:'')); ?>" placeholder="请输入代理开通价格" class="form-control">
                            </div>
                        </div>
                        <div class="fv-row row mb-9">
                            <div class="col-md-3 d-flex align-items-center">
                                <label class="fs-6 fw-semibold">代理开通介绍</label>
                            </div>
                            <div class="col-md-9">
                                <textarea type="text" id="agent_jieshao" placeholder="请输入代理开通介绍" class="form-control" rows="3"><?php echo (isset($config['agent_jieshao']) && ($config['agent_jieshao'] !== '')?$config['agent_jieshao']:''); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div id="setting_2" class="py-0 tab-pane fade" role="tabpanel">
                    <div class="card-body">
                        ...
                        <div class="d-flex fs-6 fw-semibold align-items-center mb-10">
                            <div class="bullet w-8px h-6px rounded-2 bg-primary me-3"></div>
                            <div class="fs-6 fw-semibold text-gray-400 flex-shrink-0">易支付充值信息配置</div>
                            <div class="separator separator-dashed min-w-10px flex-grow-1 mx-2"></div>
                        </div>
                        
                        <div class="fv-row row mb-9">
                            <div class="col-md-3 d-flex align-items-center">
                                <label class="fs-6 fw-semibold">易支付接口地址</label>
                            </div>
                            <div class="col-md-9">
                                <input type="text" id="epay_url" value="<?php echo htmlentities((isset($config['epay_url']) && ($config['epay_url'] !== '')?$config['epay_url']:'')); ?>" placeholder="请输入易支付接口地址" class="form-control">
                            </div>
                        </div>
                        <div class="fv-row row mb-9">
                            <div class="col-md-3 d-flex align-items-center">
                                <label class="fs-6 fw-semibold">易支付ID</label>
                            </div>
                            <div class="col-md-9">
                                <input type="text" id="epay_id" value="<?php echo htmlentities((isset($config['epay_id']) && ($config['epay_id'] !== '')?$config['epay_id']:'')); ?>" placeholder="请输入易支付ID" class="form-control">
                            </div>
                        </div>
                        <div class="fv-row row mb-9">
                            <div class="col-md-3 d-flex align-items-center">
                                <label class="fs-6 fw-semibold">易支付秘钥</label>
                            </div>
                            <div class="col-md-9">
                                <input type="text" id="epay_key" value="<?php echo htmlentities((isset($config['epay_key']) && ($config['epay_key'] !== '')?$config['epay_key']:'')); ?>" placeholder="请输入易支付秘钥" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    function setting() {
        $.ajax({
            ...
            data: {
                ...
                agent_money: $('#agent_money').val(),
                agent_jieshao: $('#agent_jieshao').val(),
