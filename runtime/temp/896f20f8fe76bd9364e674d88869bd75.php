<?php /*a:3:{s:47:"/www/wwwroot/www.biand.xyz/view/admin/user.html";i:1732793719;s:56:"/www/wwwroot/www.biand.xyz/view/layout/admin_header.html";i:1728714339;s:56:"/www/wwwroot/www.biand.xyz/view/layout/admin_footer.html";i:1732722643;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
    ...
    function dels() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "<?php echo getConfig('backstage_entrance'); ?>/user_post/dels",
                    method: 'POST',
                    data: {
                        ids:ids,
                    },
