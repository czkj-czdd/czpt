<?php /*a:2:{s:55:"/www/wwwroot/www.czysqcrxw.site/5555/view/index/my.html";i:1732194113;s:66:"/www/wwwroot/www.czysqcrxw.site/5555/view/layout/index_footer.html";i:1728755148;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN" style="--status-bar-height: 0px; --top-window-height: 0px; --window-left: 0px; --window-right: 0px; --window-margin: 0px; --window-top: calc(var(--top-window-height) + 0px); --window-bottom: calc(50px + env(safe-area-inset-bottom));">
	...
	<body class="uni-body pages-user-index">
        <div class="container">
            ...
            <a class="deal flexJA flexSb" href="/">
                <div class="left">
                    <div class="title">八方来财</div>
                    <div class="text">充值享特惠，话费加量不加价，超值福利等你来拿！</div>
                </div>
                <div class="right flexJA">专业充值平台</div>
            </a>
