<?php /*a:3:{s:55:"/www/wwwroot/th.pay51888.vip/view/admin/product_cz.html";i:1736932628;s:58:"/www/wwwroot/th.pay51888.vip/view/layout/admin_header.html";i:1736872451;s:58:"/www/wwwroot/th.pay51888.vip/view/layout/admin_footer.html";i:1736919110;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'lg': '500px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#merchant_add_modify" data-kt-drawer-close="#kt_activities_close">
    <div class="card w-100 shadow-none border-0 rounded-0">
        ...
        <div class="card-body scroll-y">
            ...
            <div class="fv-row mb-6">
                <label class="required form-label">充值产品</label>
                <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" id="product_type">
                    <option value="0">其他产品</option>
                    <option value="1">话费产品</option>
                    <option value="2">电费产品</option>
                    <option value="3">油卡产品</option>
                </select>
            </div>
            <div class="fv-row mb-6">
            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res.code === 200) {
                        ...
                        $("#product_type").val(res.data.product_type).trigger("change");
    ...
    function del(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo getConfig('backstage_entrance'); ?>/product_post/del",
                    method: 'POST',
                    data: {
                        id: id,
                    },
    ...
    function dels() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "<?php echo getConfig('backstage_entrance'); ?>/product_post/dels",
                    method: 'POST',
                    data: {
                        ids:ids,
                    },
