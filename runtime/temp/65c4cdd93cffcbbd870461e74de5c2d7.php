<?php /*a:3:{s:57:"/www/wwwroot/lxth.lat/view/admin/transaction_product.html";i:1736872451;s:51:"/www/wwwroot/lxth.lat/view/layout/admin_header.html";i:1736942563;s:51:"/www/wwwroot/lxth.lat/view/layout/admin_footer.html";i:1736919110;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
    ...
    function dels() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "<?php echo getConfig('backstage_entrance'); ?>/transaction_product_post/dels",
                    method: 'POST',
                    data: {
                        ids:ids,
                    },
