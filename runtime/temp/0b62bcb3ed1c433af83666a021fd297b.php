<?php /*a:1:{s:71:"/www/wwwroot/www.czysqcrxw.site/5555/view/index/order_voucher_edit.html";i:1732125550;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="container">
        	...
        	<div class="item">
        		<div class="bar flexJA flexFs bb1">
        			...
        			<uni-input class="input">
    					...
    					<input class="uni-input-input" placeholder="请输入">
        				</div>
        			</uni-input>
        		</div>
        	...
        	<div class="item">
        		<div class="bar flexJA flexFs bb1">
        			...
        			<uni-input class="input">
        				<div class="uni-input-wrapper">
        					<div class="uni-input-placeholder input-placeholder" style="display: none;">请输入</div>
        	...
        	<div class="bottom flexJA">
        		<div class="button flexJA">保存</div>
        	</div>
        </div>
