<?php /*a:2:{s:43:"/www/wwwroot/lxth.lat/view/index/index.html";i:1740310031;s:51:"/www/wwwroot/lxth.lat/view/layout/index_footer.html";i:1736872451;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN" >
	<head>
        ...
        <style>
            ...
            /* .main .list .item:nth-last-child(-n+1) {*/
	...
	<body class="uni-body pages-home-index">
                ...
                <div class="main">
                    ...
                    <div class="list">
                       <!--  <div class="item flexJA flexSb">
                        ...
                        <div class="item flexJA flexSb" style="width:30%" onclick="window.location.href='/product/<?php echo htmlentities($vo['id']); ?>'">
                            <uni-image class="icon">
        ...
        <footer class="footer-bottom">
           ...
           <script>
        // 获取所有页脚导航栏项目
            // 获取所有的footer__label元素
        const footerLabels = document.querySelectorAll('.footer__label');
        
        // 为每个footer__label添加点击事件监听器
        footerLabels.forEach(label => {
            label.addEventListener('click', function() {
                // 目标样式
                const newStyle = 'color: rgb(153, 153, 153); font - size: 10px; line - height: normal; margin - top: 3px;';
                // 如果当前元素的颜色是特定颜色则进行切换
                if (this.style.color === 'rgb(56, 117, 244)') {
                    this.style.cssText = newStyle;
                } else {
                    // 还原的样式（这里假设初始状态是有特定颜色的）
                    const originalStyle = 'color: rgb(56, 117, 244); font - size: 10px; line - height: normal; margin - top: -5px;';
