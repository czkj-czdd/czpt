<?php /*a:1:{s:55:"/www/wwwroot/th.pay51888.vip/view/index/order_info.html";i:1736872451;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="container">
            <div class="above">
                ...
                <?php if($order_info['status'] == 0): ?>
                    ...
                    <div class="tips">因高峰期会出现延迟情况,一切以实际到账为准，如与实际到账金额不符，联系客服退款部分未到金额</div>
            ...
            <div class="below">
                ...
                <div class="bar flexJA flexSb">
                    ...
                    <div class="num"><?php echo htmlentities($order_info['amount_money']); ?> 元</div>
                      ...
                      <div class="bar flexJA flexSb">
                    <div class="text">实际到账</div>
                    <div class="num"><?php echo htmlentities($order_info['amount_received']); ?> 元</div>
                </div>
               
                <div class="bar flexJA flexSb">
                    <div class="text">优惠信息</div>
                    <div class="discount">折扣<?php echo htmlentities((isset($order_info['discount']) && ($order_info['discount'] !== '')?$order_info['discount']:'0')); ?> 优惠-<?php echo htmlentities($order_info['discount_amount']); ?>元</div>
                </div>
                <div class="bar flexJA flexSb">
            ...
            <div class="bottoms">
                <div class="menu flexJA flexSb">
                    ...
                    <a class="item flexJA flexDc" href="/order_voucher?id=<?php echo htmlentities($order_info['id']); ?>">
                        <uni-image class="icon" style="width: 24px;">
                            <div style="background-image: url(/static/index/image/89.png); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;"></div>
                        </uni-image>
                        <div class="text1">付款凭证</div>
                    </a>
