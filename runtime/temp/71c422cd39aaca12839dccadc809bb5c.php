<?php /*a:2:{s:65:"/www/wwwroot/th.pay51888.vip/view/index/bank_card_add_modify.html";i:1736940452;s:58:"/www/wwwroot/th.pay51888.vip/view/layout/index_footer.html";i:1736872451;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="container">
            <div class="list">
                ...
                <div class="item">
                    ...
                    <div class="input">
                        <div class="uni-input-wrapper">
                            <input type="text" class="uni-input-input" placeholder="请输人微信昵称" value="<?php echo htmlentities((isset($BankCard_info['wx_account']) && ($BankCard_info['wx_account'] !== '')?$BankCard_info['wx_account']:'')); ?>" id="wx_account">
                        </div>
                    </div>
                </div>
                <div class="item">
                    <div class="title">微信手机号</div>
                    <div class="input">
                        <div class="uni-input-wrapper">
                            <input type="text" class="uni-input-input" placeholder="请输人微信手机号码" value="<?php echo htmlentities((isset($BankCard_info['zfb_account']) && ($BankCard_info['zfb_account'] !== '')?$BankCard_info['zfb_account']:'')); ?>" id="zfb_account">
                        </div>
                    </div>
                </div>
            </div>
