<?php /*a:3:{s:49:"/www/wwwroot/103.117.122.101/view/admin/user.html";i:1738851142;s:58:"/www/wwwroot/103.117.122.101/view/layout/admin_header.html";i:1736942563;s:58:"/www/wwwroot/103.117.122.101/view/layout/admin_footer.html";i:1736919110;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
    ...
    function del(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo getConfig('backstage_entrance'); ?>/user_post/del",
                    method: 'POST',
                    data: {
                        id: id,
                    },
